                ...
                <div class="panel panel-body">
                    ...
                    <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="store">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Product Name" id="product_name" class="form-control input-md" wire:model="name" wire:keyup="generateSlug">
                                @error('name') <div class="error" style="color: red;">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="product_slug" class="col-md-4 control-label">Slug</label>
                            <div class="col-md-4">
                                <input type="text" placeholder="Product Slug" id="product_slug" class="form-control input-md" wire:model="slug"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" id="product_image" class="input-file" wire:model="newImage">
                                <div class="{{ $newImage || $prevImage ? '' : 'invisible' }}" style="width: 120px;height: 120px;" >
                                    @if($newImage)
                                        <img src="{{ $newImage->temporaryUrl() }}" width="120" alt="">
                                    @else
                                        <img src="{{ asset('assets/images/products') }}/{{ $prevImage }}" width="120" alt="">
                                    @endif
                                </div>
